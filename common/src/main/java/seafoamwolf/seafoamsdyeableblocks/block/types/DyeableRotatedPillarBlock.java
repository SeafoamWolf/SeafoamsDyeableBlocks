package seafoamwolf.seafoamsdyeableblocks.block.types;
...
public class DyeableRotatedPillarBlock extends RotatedPillarBlock implements DyeableBlockInterface {
    public static TagKey<Block> OriginalBlocks;

	public DyeableRotatedPillarBlock(BlockBehaviour.Properties settings) {
		super(settings);
