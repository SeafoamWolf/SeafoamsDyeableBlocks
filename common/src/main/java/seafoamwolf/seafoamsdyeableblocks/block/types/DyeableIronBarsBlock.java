...
public class DyeableIronBarsBlock extends IronBarsBlock implements DyeableBlockInterface {
	public DyeableIronBarsBlock(BlockBehaviour.Properties settings) {
		super(settings);
