...
public class DyeablePillarBlock extends RotatedPillarBlock implements DyeableBlockInterface {
    public static TagKey<Block> OriginalBlocks;

	public DyeablePillarBlock(BlockBehaviour.Properties settings) {
		super(settings);
