...
public class DyedStainedGlassBlock extends StainedGlassBlock implements DyedBlockInterface {
    public DyedStainedGlassBlock(AbstractBlock.Settings settings) {
        super(DyeColor.WHITE, settings);
    }

    public DyedStainedGlassBlock(Block baseBlock) {
