...
public class DyedCarpetBlock extends CarpetBlock implements DyedBlockInterface {
	public DyedCarpetBlock(Settings settings) {
		super(settings);
	}

    public DyedCarpetBlock(Block baseBlock) {
