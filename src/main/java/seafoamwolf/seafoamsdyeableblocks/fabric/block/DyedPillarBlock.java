...
public class DyedPillarBlock extends PillarBlock implements DyedBlockInterface {
    public DyedPillarBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    
    public DyedPillarBlock(Block baseBlock) {
